...
@media only screen and (max-width: 768px) {
  ...
  <body>
    ...
    <!-- <div class="container-fluid banner">
        ...
        <div class="container">
          <div class="row">
            <div class="col-8" style="margin: 0 auto; float: none; margin-bottom: 10px; margin-top: 10px;">
              <div class="card">
                <div class="card-body">
                  <table class="table table-striped" style="text-align: center;">
                    ...
                    <?php $i = 1; ?>
                      ...
                      <tr>
                        <td scope="row"><?= $i; ?></td>
                        <td><img src="<?= "upload/".$tes['foto']; ?>" height="30px" width="30px" alt="Image"></td>
                        <td><?= $tes['nama_menu']; ?></td>
                        <td>
                        <p>
                        <a href="<?= base_url('/menu/'.$tes['id_menu']); ?>"><button class="btn btn-success" type="button" data-bs-toggle="collapse" data-bs-target="#meimei<?= $tes['id_menu']; ?>" aria-expanded="false" aria-controls="meimei<?= $tes['id_menu']; ?>">Detail</button></a>
                        </p>
                        <div class="collapse <?= $tes['id_menu']; ?>" id="meimei<?= $tes['id_menu']; ?>">
                          <div class="card card-body">
                            <p><?= $tes['deskripsi_menu']; ?></p>
                          </div>
                        </div>
                      </td>
                      </tr>
